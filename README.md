...
反代出来的Claude Sonnet4.6 大概是1.5折左右, 折合下来, 一个请求大概
Opus 4.6的各个渠道最近比较贵, 也不太稳定. 
...
### 四.[FoxCode](https://foxcode.rjj.cc/auth/register?aff=5O8P)
之前这个网站是有包月套餐的,  现在只有按量计费的

这个网站的AWS渠道(其实就是kiro反代), 是我看到过最便宜的, 相当于官方的0.8折.
